...
<div class="headlinewrap" style="white-space: nowrap; padding-bottom: 10px;">
                        ...
                        <div class="mx-auto" style="width: 200px;">
                            <button onclick="location.href='https://www.youtube.com/@myracedata3023/streams'" style="height: 60px; width: 180px; background-image: url('./images/Youtube-white.png'); background-size: cover; background-color: black; border-radius: 12px;"></button>
                        </div>
                    </div>
    <p>
